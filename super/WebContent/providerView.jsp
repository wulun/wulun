...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <div class="providerView">
            <p><strong>供应商编码：</strong><span>${provider.proid }</span></p>
            <p><strong>供应商名称：</strong><span>${provider.providername }</span></p>
            <p><strong>联系人：</strong><span>${provider.contacts }</span></p>
            <p><strong>联系电话：</strong><span>${provider.tel }</span></p>
            <p><strong>传真：</strong><span>${provider.fax }</span></p>
            <p><strong>描述：</strong><span>${provider.describe }</span></p>
